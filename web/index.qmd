...
points(auc_val, 1 - auc_val, 
       ...
       pch = 21)
abline(a = 0, b = 1)
knn.kfoldCV.perform_obj<- recordPlot()
...
points(auc_val, 1 - auc_val, 
       ...
       pch = 21)
abline(a = 0, b = 1)
knn.kfoldCV_mod.perform_obj <- recordPlot()
...
points(auc_val, 1 - auc_val, 
       ...
       pch = 21)
abline(a = 0, b = 1)
knn.holdoutCV.perform_obj <- recordPlot()
...
points(auc_val, 1 - auc_val, 
       ...
       pch = 21)
abline(a = 0, b = 1)
knn.holdoutCV_mod.perform_obj <- recordPlot()
...
points(auc_val, 1 - auc_val, 
       ...
       pch = 21)
abline(a = 0, b = 1)
knn.looCV.perform_obj <- recordPlot()
...
points(auc_val, 1 - auc_val, 
       ...
       pch = 21)
abline(a = 0, b = 1)
knn.looCV_mod.perform_obj <- recordPlot()
...
points(auc_val, 1 - auc_val, 
       ...
       pch = 21)
abline(a = 0, b = 1)
knn.repeatedCV.perform_obj <- recordPlot()
...
points(auc_val, 1 - auc_val, 
       ...
       pch = 21)
abline(a = 0, b = 1)
knn.repeatedCV_mod.perform_obj <- recordPlot()
...
```{r Accuracy.Kappa.Plot, fig.width=15, fig.height=20}
