...
| Resampling Method                                | Error Rate | Sensitivity | Specificity | AUC       |
| ------------------------------------------------ | ---------- | ----------- | ----------- | --------- |
| Logistic Regression (`caret`)                    | 0.1944     | 0.9347      | 0.2929      | 0.6137776 |
| Logistic Regression (`caret` tuned with stepAIC) | 0.1919     | 0.98946     | 0.08787     | 0.5386644 |
| Logistic Regression (`MASS` K-fold CV)           | 0.1793     | 0.99687     | 0.09091     | 0.5438871 |
...
# Calculate the accuracy of the predictions on the testing set
test.accuracy <- mean(test$good == lda.pred$class)
```
...
| LDA (`MASS`)      | 0.1793     | 0.9937      | 0.1039      | 0.5488133 |
| LDA (`class`)     | 0.xxxx     | 0.xxxx      | 0.xxxx      | 0.xxxxxxx |
...
| QDA (`class`)     | 0.xxxx     | 0.xxxx      | 0.xxxx      | 0.xxxxxxx |
...
| QDA (`caret`)     | 0.2559     | 0.7418      | 0.7531      | 0.7474858 |
| QDA (`MASS`)      | 0.1692     | 0.8934      | 0.5714      | 0.7324227 |
| QDA (`class`)     | 0.0000     | 0.0000      | 0.0000      | 0.0000000 |
